...
Partial Class general_acc
    ...
    Protected Sub btndone_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btndone.Click
        ...
        pass = ""
        dept = Session("dept")
        cmdstr = "select * from user_info where user_id='" & dept & "'"
        ...
        If (reader.Read) Then
            ...
            Else
                ...
                Else
                    ...
                    cmdstr = "UPDATE [user_info] SET user_password='" & CryptoSecurity.Encrypt(txtnew.Text) & "' where user_id='" & dept & "'"
                    cmd = New SqlCommand(cmdstr, conn)
                    cmd.ExecuteNonQuery()

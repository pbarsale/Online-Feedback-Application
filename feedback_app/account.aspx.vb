...
Partial Class account
    ...
    Protected Sub btndone_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btndone.Click
        ...
        pass = ""
        dept = Session("dept")
        cmdstr = "select * from user_info where user_id='" & dept & "' and user_role='Admin'"
        ...
        If (reader.Read) Then
            ...
            Else
                ...
                Else
                    ...
                    cmdstr = "UPDATE [user_info] SET user_password='" & CryptoSecurity.Encrypt(txtnew.Text) & "' where user_id='" & dept & "' and user_role='Admin'"
                    cmd = New SqlCommand(cmdstr, conn)
                    cmd.ExecuteNonQuery()

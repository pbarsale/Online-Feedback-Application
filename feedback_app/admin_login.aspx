<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admin_login.aspx.vb"  Inherits="admin_login" Title="Login Form" %>
...
<body onload="runSlideShow()">
    ...
    <div id="apDiv10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <asp:HyperLink ID="HyperLink2" runat="server" Font-Names="Times New Roman" 
                  Font-Size="Large" ForeColor="Black" NavigateUrl="~/login.aspx">Back</asp:HyperLink>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink3" runat="server" ForeColor="Black" 
            NavigateUrl="~/startfeedback.aspx">Start Feedback</asp:HyperLink>
        </div>
    <div id="apDiv11">
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div id="apDiv12" style="background-color: #E5E5E5">
      <div id="apDiv14">
      <table width="251" style="height: 167px">
        <tr>
         ...
         <tr>
         <td bgcolor="#E5E5E5" class="style12" 
         ...
         <tr>
          <td bgcolor="#E5E5E5" class="style14" 
                
                
                 style="background-color: #E2E2E2; font-family: 'Times New Roman', Times, serif; font-size: medium; font-weight: bold; font-style: normal; color: #336699;">
              &nbsp;Password&nbsp;&nbsp; :&nbsp;</td>
          <td bgcolor="#E5E5E5" class="style15">
              <asp:TextBox ID="txtpass" runat="server" TextMode="Password" Width="131px"></asp:TextBox> 
              <br />
              <asp:Label ID="lblmsg" runat="server" Font-Bold="False" Font-Size="Medium" 

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login.aspx.vb"  Inherits="login" Title="Login Form" %>
...
<body onload="runSlideShow()">
    <form id="form1" runat="server">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <div id="apDiv21" style="font-size: medium">
          <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="White" 
              NavigateUrl="~/principal_login.aspx">Principal Login</asp:HyperLink>
      </div>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <div id="apDiv20" style="font-size: medium">
          <asp:HyperLink ID="HyperLink1" runat="server" BackColor="#506A92" 
              ForeColor="White" NavigateUrl="~/admin_login.aspx">Admin Login</asp:HyperLink>
      </div>
      </div>
    <div id="apDiv10"></div>
    <div id="apDiv11">
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div id="apDiv12" style="background-color: #E5E5E5">
      <div id="apDiv14">
      <table width="251" style="height: 226px">
        <tr>
          ...
          <td width="145" bgcolor="#E5E5E5" class="style23">
              <asp:DropDownList ID="ddluname" runat="server" AutoPostBack="True">
                  <asp:ListItem Selected="True" Value="CS">Computer Engg</asp:ListItem>
                  <asp:ListItem Value="CE">Civil Engg</asp:ListItem>
                  <asp:ListItem Value="EE">Electrical Engg</asp:ListItem>
                  <asp:ListItem Value="ET">Electronics &amp; Tele</asp:ListItem>
                  <asp:ListItem Value="IT">Information Tech</asp:ListItem>
         ...
         <td bgcolor="#E5E5E5" class="style22" 
              ...
              &nbsp;Course&nbsp;:&nbsp;</td>
              <td class="style23">
                  <asp:DropDownList ID="ddlucourse" runat="server" Width="132px">
         ...
         <td bgcolor="#E5E5E5" class="style22" 
              ...
              &nbsp;User Type&nbsp;:&nbsp;</td>
              <td class="style23">
                  <asp:DropDownList ID="ddlutype" runat="server" Width="132px">
         ...
         <tr>
          <td bgcolor="#E5E5E5" class="style24" 
        ...
        <tr style="border-color: #E4E4E4">
          <td bgcolor="#E5E5E5" class="style6">
      
              </td>
          <td bgcolor="#E5E5E5" class="style2" style="border-style: hidden">
              <asp:Label ID="lblmsg" runat="server" ForeColor="Red"></asp:Label>
              <br />
              <asp:Button ID="Btnlogin" runat="server" Text="Submit" Height="26px" 
                  Width="66px"  />
              <br />
          </td>
        </tr>
    ...
    style="background-color: #AEAEAE; font-weight: bold; font-style: normal; font-size: small; font-family: 'Times New Roman', Times, serif; color: #FFFFFF;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select department as your Username</div>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <div id="apDiv17">The students feedback provide about your teaching on their 
        end-of-semester course evaluations which can be valuable in helping you improve and 
    ...
    <ul>
     <li>Government College Of Engineering,Aurangabad.</li><br />
      ...
      <li>Making Feedback evaluation simpler for the Institute.</li><br /></ul></marquee>
    </div>
    <div id="apDiv19"></div>
<p>&nbsp;</p>
    <div id="apDiv16" 

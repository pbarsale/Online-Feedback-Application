...
Partial Class report_all
    ...
    Dim sname(15), course(50), course_id(40), d_name(20), deptname(20) As String
    Dim per(40), t As Double
    Dim class_nm(4) As String
    Dim tbtheory(10) As Table
    Dim tbprac(10) As Table
    Dim i, j, c, s, count, num, counter, chkelective As Integer
    Dim dept, p, degree, elective(50), total_students(50) As String
    Dim temp As Double
    Dim f1 As New fetch
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ElseIf dept = "MCA" Then
            lbldept.Text = "MCA Department "

        ElseIf dept = "ALL" Then
            lbldept.Text = "All Branches "
    ...
    Protected Sub btndone_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btndone.Click
                ...
                For Me.i = 1 To (k - 1)
                    For Me.j = (Me.i + 1) To k
                        ...
                        If per(Me.i) < per(j) Then
                            swap(course(Me.i), course(Me.j))
                            swap(course_id(Me.i), course_id(Me.j))
                            swap(sname(Me.i), sname(Me.j))

                            temp = elective(Me.i)                      ' To swap elective array elements for ordering
                            elective(Me.i) = elective(Me.j)
                            elective(Me.j) = temp

                            temp = total_students(Me.i)                ' To swap total students array elements for ordering
                            total_students(Me.i) = total_students(Me.j)
                            total_students(Me.j) = temp
        ...
        Else
            ...
            d_name = {"CS", "IT", "CE", "ME", "EE", "EC", "MCA"}
            deptname = {"Computer Science and Enginnering", "Information Technology Department", "Civil Enginnering Department", "Mechanical Enginnering Department", "Electrical Enginnering Department", "Electronics and Telecommunication Enginnering Department", "Master of Computer Application"}
            ...
            For z = 0 To 6
                ...
                While (s <= num)
                    ...
                    cmdstr1 = "select c.course_name,c.course_code,c.iselective,s.sem from course_info c, staff_theory s where c.dept_name='" & d_name(z) & "' and s.sem=" & s & " and c.course_code=s.course_code and c.degree='" & degree & "' and c.annual_year='" & ddlannualyear.SelectedValue & "'"
                    ...
                    While (reader1.Read)
                        ...
                        If reader1("iselective") = 1 Then
                            ...
                            chkelective = f1.checkelectiveresponse(reader1("course_code"), d_name(z), ddlannualyear.SelectedValue, "t")
                    ...
                    While (k <= j - 1)
                        ...
                        cmdstr2 = "select staff_name from staff_theory where course_code='" & course_id(k) & "' and dept_name='" & d_name(z) & "' and sem=" & s & " and annual_year='" & ddlannualyear.SelectedValue & "'"
                        cmd2 = New SqlCommand(cmdstr2, conn)
                        reader2 = cmd2.ExecuteReader

                        If (reader2.Read) Then

                            sname(k) = reader2("staff_name")
                            'MsgBox(sname(i))
                        End If
                        reader2.Close()
                        k = k + 1
                    ...
                    While (k <= j - 1)
                        Me.i = 0
                        cmdstr2 = "select percentage from theory where course_code='" & course_id(k) & "' and dept_name='" & d_name(z) & "' and sem=" & s & " and annual_year='" & ddlannualyear.SelectedValue & "'"
                        cmd2 = New SqlCommand(cmdstr2, conn)
                        reader2 = cmd2.ExecuteReader
                        t = 0
                        While (reader2.Read)
                    ...
                    thead.Cells(0).Text = "Sr. NO."
                    thead.Cells(1).Text = "Name of Faculty"
                    thead.Cells(2).Text = "Course Name"
                    thead.Cells(3).Text = "Staff Index"
                    thead.Cells(4).Text = "Total Students"
                    ...
                    For Me.c = 1 To (count - 1)
                        ...
                        If z <> 0 Then
                            If c = 1 And (s = 1 Or s = 2) Then
                                tbtheory(s).Caption = String.Concat(deptname(z), " : ", "Theory :", l1.Text, "        ", "(", "Total Students : ", counter, ")")
                            End If

                        Else
                            If c = 1 And (s = 3 Or s = 4) Then
                                tbtheory(s).Caption = String.Concat(deptname(z), " : ", "Theory :", l1.Text, "        ", "(", "Total Students : ", counter, ")")
                            End If
                        End If
                    ...
                    cmdstr1 = "select c.course_name,c.iselective,c.course_code,s.sem from course_info c, staff_practical s where c.dept_name='" & d_name(z) & "' and s.sem=" & s & " and c.course_code=s.course_code and c.degree='" & degree & "' and c.annual_year='" & ddlannualyear.SelectedValue & "'"
                    ...
                    While (reader1.Read)
                        ...
                        If reader1("iselective") = 1 Then
                            ...
                            chkelective = f1.checkelectiveresponse(reader1("course_code"), d_name(z), ddlannualyear.SelectedValue, "p")
                    ...
                    While (k <= j - 1)
                        ...
                        cmdstr2 = "select staff_name from staff_practical where course_code='" & course_id(k) & "' and dept_name='" & d_name(z) & "' and sem=" & s & " and annual_year='" & ddlannualyear.SelectedValue & "'"
                        cmd2 = New SqlCommand(cmdstr2, conn)
                        reader2 = cmd2.ExecuteReader
                    ...
                    While (k <= j - 1)
                        i = 0
                        cmdstr2 = "select percentage from practical where course_code='" & course_id(k) & "' and dept_name='" & d_name(z) & "' and sem=" & s & " and annual_year='" & ddlannualyear.SelectedValue & "'"
                        cmd2 = New SqlCommand(cmdstr2, conn)
                        reader2 = cmd2.ExecuteReader
                        t = 0
                        While (reader2.Read)
                    ...
                    thead1.Cells(0).Text = "Sr. NO."
                    thead1.Cells(1).Text = "Name of Faculty"
                    thead1.Cells(2).Text = "Course Name"
                    thead1.Cells(3).Text = "Staff Index"
                    thead1.Cells(4).Text = "Total Students"

                    tbprac(s) = New Table
                    tbprac(s).BorderColor = Drawing.Color.Gray
                    tbprac(s).Caption = "Practical  :"
                    tbprac(s).BorderWidth = 3
                    tbprac(s).BorderStyle = BorderStyle.Groove
                    tbprac(s).CellPadding = 10
                    tbprac(s).CellSpacing = 2
    ...
    Protected Sub ddlbranch_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlbranch.SelectedIndexChanged
        ...
        If ddlbranch.SelectedValue = "MCA" Then
            ddldegree.SelectedValue = "PG"
            ddldegree.Enabled = False
        Else
            ddldegree.SelectedValue = "UG"
